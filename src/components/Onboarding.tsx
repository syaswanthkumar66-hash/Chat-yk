    ...
    <div className="flex flex-col items-center justify-center min-h-screen p-4 md:p-6 bg-bg-light relative overflow-hidden">
      ...
      <AnimatePresence mode="wait">
        {step === 'login' ? (
          ...
          >
            <div className="bg-white p-8 md:p-10 rounded-[2.5rem] md:rounded-[3rem] border border-slate-100 shadow-2xl shadow-slate-200/50 space-y-8 md:space-y-10">
              <div className="flex flex-col items-center text-center gap-4 md:gap-6">
                <div className="size-16 md:size-20 rounded-[1.5rem] md:rounded-[2rem] bg-primary flex items-center justify-center text-white shadow-2xl shadow-primary/40 rotate-3">
                  <Icon name="share_reviews" className="text-4xl md:text-5xl" fill />
                </div>
                <div>
                  <h2 className="text-3xl md:text-4xl font-black text-slate-900 uppercase tracking-tighter italic leading-none">Connect</h2>
                  <p className="text-[8px] md:text-[10px] font-black text-slate-400 uppercase tracking-[0.3em] mt-2 md:mt-3">Private Digital Ecosystem</p>
                </div>
                <p className="text-slate-500 text-xs md:text-sm font-medium leading-relaxed px-2 md:px-4">
                  Experience the next generation of direct peer-to-peer communication.
                </p>
              </div>

              <div className="space-y-3">
                <Button onClick={handleGoogleLogin} className="w-full h-14 md:h-16 rounded-2xl font-black uppercase tracking-widest italic text-xs md:text-sm shadow-xl shadow-primary/20">
              ...
              <div className="pt-4 md:pt-6 border-t border-slate-50 text-center">
                <p className="text-[8px] md:text-[9px] font-black uppercase tracking-[0.4em] text-slate-300">Secured by Social Cloud Protocol</p>
              </div>
            </div>
