...
export default function App() {
  ...
  const [testCallInfo, setTestCallInfo] = useState<{ id: string, type: 'voice' | 'video' | 'walkie-talkie' } | null>(null);
  ...
  useEffect(() => {
    ...
    const joinCallType = urlParams.get('type') as 'voice' | 'video' | 'walkie-talkie' || 'video';
    if (joinCallId) {
